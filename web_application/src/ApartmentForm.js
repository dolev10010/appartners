...
import CityStreetSelector from './CityStreetSelector';

const ApartmentForm = ({ apartment, imagePreviews, onChange, onPhotoUpload, onRemovePhoto, onSubmit, onCancel, onCoordinatesChange }) => {
  ...
  const handleStreetChange = (value) => {
    onChange({ target: { name: 'street', value } });
  };
  ...
  const handleFloorChange = (value) => {
    onChange({ target: { name: 'floor', value } });
  };

  return (
    <div className="post-apartment-apartmentForm">
      {/* City, Street, Number, and Floor Selector */}
      <CityStreetSelector 
        city={apartment.city} 
        ...
        onCoordinatesChange={onCoordinatesChange} // Handle coordinates
      />
      ...
      <div className="post-apartment-formRow">
        ...
        <div className="post-apartment-formGroup">
          ...
          <input
            ...
            value={apartment.appartment_size}
            onChange={onChange}
            min="1"
            className="post-apartment-input formBoxes"
          />
        ...
        <div className="post-apartment-formGroup">
          ...
          <input
            ...
            value={apartment.available_rooms}
            onChange={onChange}
            min="1"
            className="post-apartment-input formBoxes"
          />
      ...
      <div className="post-apartment-formRow">
        <div className="post-apartment-formGroup">
          ...
          <input
            type="number"
            name="num_of_toilets"
            value={apartment.num_of_toilets}
            onChange={onChange}
            min="1"
            className="post-apartment-input formBoxes"
          />
        ...
        <div className="post-apartment-formGroup">
          ...
          <input
            type="number"
            name="num_of_roommates"
            value={apartment.num_of_roommates}
            onChange={onChange}
            min="1"
            className="post-apartment-input formBoxes"
          />
      ...
      <div className="post-apartment-formRow">
        ...
        <div className="post-apartment-formGroup">
          ...
          <input
            type="checkbox"
            name="has_elevator"
            checked={apartment.has_elevator}
            onChange={onChange}
          />
        </div>
        <div className="post-apartment-formGroup">
      ...
      <div className="post-apartment-formRow">
        <div className="post-apartment-formGroup">
          ...
          <input
            type="checkbox"
            name="is_furnished"
            checked={apartment.is_furnished}
            onChange={onChange}
          />
        </div>
        <div className="post-apartment-formGroup">
          ...
          <input
            ...
            checked={apartment.has_air_conditioner}
            onChange={onChange}
          />
        </div>
        <div className="post-apartment-formGroup">
          ...
          <input
            type="checkbox"
            name="has_sun_water_heater"
            checked={apartment.has_sun_water_heater}
            onChange={onChange}
          />
        </div>
      </div>
      ...
      <div className="post-apartment-formRow">
        ...
        <div className="post-apartment-formGroup">
          ...
          <input
            type="checkbox"
            name="is_accessible_to_disabled"
            checked={apartment.is_accessible_to_disabled}
            onChange={onChange}
          />
        </div>
      </div>
      ...
      <div className="post-apartment-formRow">
        ...
        <div className="post-apartment-formGroup">
          ...
          <select
            ...
            onChange={onChange}
            className="post-apartment-input formBoxes small-height"
          >
      ...
      <div className="post-apartment-formGroup">
        <input
          ...
          className="post-apartment-fileInput"
        />
          ...
          {imagePreviews.map((src, index) => (
            <div key={index} className="post-apartment-imagePreviewWrapper">
              <img
                src={src}
                alt={`Preview ${index}`}
                className="post-apartment-imagePreview"
                onClick={() => handleImageClick(src)}
              />
              <button
                className="post-apartment-removeButton"
